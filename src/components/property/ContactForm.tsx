	...
	return (
		<ContactFormContainer static={props.static} scrollPosition={scrollPosition}>
            ...
            <ContactFooter static={props.static}>
                ...
                realtor.com and others about your inquiry and other home-
                related matters, but not as a condition of any purchase; this 
                applies regardless of whether you check, or leave un-
                checked, any box above
            </ContactFooter>
